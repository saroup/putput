...
def replace_with_synonyms(utterance: str,
    ...
    return _replace_with_synonyms(handled_groups, chance)

def _replace_with_synonyms(handled_groups: Sequence[str],
                           chance: int
                           ) -> Tuple[str, Sequence[str], Sequence[str]]:
    synonym_utterances, synonym_tokens, synonym_groups = [], [], []
    for handled_group in handled_groups:
        num_parens, utterance_components, token_components, group_components = 0, [], [], []

...
from putput.pattern_definition_validator import PatternDefinitionValidationException
...
class TestPatternDefinitionValidator(unittest.TestCase):
    ...
    def _raise_exception(self,
                         input_file_name: str,
                         exception: Type[PatternDefinitionValidationException],
    ...
    def test_token_pattern_too_few_lists(self) -> None:
        ...
        self._raise_exception(input_file_name, PatternDefinitionValidationException)
